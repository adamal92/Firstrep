...
//		button.addActionListener((ActionEvent e) -> { textArea.append("Button was clicked\n"); });
		...
		stser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(Server.hasInstance())textArea.append("server is already up\n");
				Thread server = new Thread(Server.getInstance(), "server"); server.start();
				}});
		...
		JMenuItem expdtitm = new JMenuItem("Export Data Item");
		JMenuItem imprtdtit = new JMenuItem("Import Data Item");
		JMenuItem exitItem = new JMenuItem("Exit");
		exitItem.addActionListener(new Action(){
			private boolean b=true;
			public Object getValue(String key){return null;}
			public boolean isEnabled(){return this.b;}
			public void putValue(String key, Object value){}
